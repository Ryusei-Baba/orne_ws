...
(cl:defmethod cl:initialize-instance :after ((m <Pose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fulanghua_srvs-srv:<Pose-request> is deprecated: use fulanghua_srvs-srv:Pose-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <Pose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fulanghua_srvs-srv:pose-val is deprecated.  Use fulanghua_srvs-srv:pose instead.")
  (pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <Pose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fulanghua_srvs-srv:<Pose-response> is deprecated: use fulanghua_srvs-srv:Pose-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <Pose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fulanghua_srvs-srv:status-val is deprecated.  Use fulanghua_srvs-srv:status instead.")
  (status m))
